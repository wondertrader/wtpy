...
class DumperSink:
    def on_account(self, channelid, curTDate: int, currency, prebalance: float, balance: float, dynbalance: float,
                   closeprofit: float, dynprofit: float, fee: float, margin: float, deposit: float, withdraw: float,
                   isLast: bool):
        pass

    def on_order(self, channelid, exchg, code, curTDate: int, orderid, direct: int, offset: int,
                 volume: float, leftover: float, traded: float, price: float, ordertype: int, pricetype: int,
                 ordertime: int, state: int, statemsg, isLast: bool):
        pass

    def on_trade(self, channelid, exchg, code, curTDate: int, tradeid, orderid, direct: int,
                 offset: int, volume: float, price: float, amount: float, ordertype: int, tradetype: int,
                 tradetime: int, isLast: bool):
        pass
