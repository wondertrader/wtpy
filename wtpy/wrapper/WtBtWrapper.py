...
from wtpy.WtCoreDefs import CB_STRATEGY_INIT, CB_STRATEGY_TICK, CB_STRATEGY_CALC, CB_STRATEGY_BAR, CB_STRATEGY_GET_BAR, \
    CB_STRATEGY_GET_TICK, CB_STRATEGY_GET_POSITION, CB_STRATEGY_COND_TRIGGER
...
class WtBtWrapper:
    ...
    def on_stra_get_bar(self, id: int, stdCode: str, period: str, curBar: POINTER(WTSBarStruct), count: int,
                        isLast: bool):
        """
    ...
    def on_hftstra_order(self, id: int, localid: int, stdCode: str, isBuy: bool, totalQty: float, leftQty: float,
    ...
    def on_hftstra_trade(self, id: int, localid: int, stdCode: str, isBuy: bool, qty: float, price: float,
                         userTag: str):
        stdCode = bytes.decode(stdCode)
        userTag = bytes.decode(userTag, "gbk")
        engine = self._engine
    ...
    def on_hftstra_get_order_queue(self, id: int, stdCode: str, newOrdQue: POINTER(WTSOrdQueStruct), count: int,
                                   isLast: bool):
        engine = self._engine
        ctx = engine.get_context(id)
    ...
    def on_hftstra_get_order_detail(self, id: int, stdCode: str, newOrdDtl: POINTER(WTSOrdDtlStruct), count: int,
                                    isLast: bool):
        engine = self._engine
        ctx = engine.get_context(id)
    ...
    def on_hftstra_get_transaction(self, id: int, stdCode: str, newTrans: POINTER(WTSTransStruct), count: int,
                                   isLast: bool):
        engine = self._engine
        ctx = engine.get_context(id)
    ...
    def initialize_cta(self, logCfg: str = "logcfgbt.yaml", isFile: bool = True, outDir: str = "./outputs_bt"):
        ...
        try:
            ...
            self.api.register_cta_callbacks(self.cb_stra_init, self.cb_stra_tick,
                                            ...
                                            self.cb_stra_calc_done, self.cb_stra_cond_trigger)
    ...
    def cta_enter_long(self, id: int, stdCode: str, qty: float, usertag: str, limitprice: float = 0.0,
                       stopprice: float = 0.0):
        """
        开多
        @id         策略id
        ...
        @qty        手数, 大于等于0
        """
        self.api.cta_enter_long(id, bytes(stdCode, encoding="utf8"), qty, bytes(usertag, encoding="utf8"), limitprice,
                                stopprice)

    def cta_exit_long(self, id: int, stdCode: str, qty: float, usertag: str, limitprice: float = 0.0,
                      stopprice: float = 0.0):
        """
        平多
        @id         策略id
        ...
        @qty        手数, 大于等于0
        """
        self.api.cta_exit_long(id, bytes(stdCode, encoding="utf8"), qty, bytes(usertag, encoding="utf8"), limitprice,
                               stopprice)

    def cta_enter_short(self, id: int, stdCode: str, qty: float, usertag: str, limitprice: float = 0.0,
                        stopprice: float = 0.0):
        """
        开空
        @id         策略id
        ...
        @qty        手数, 大于等于0
        """
        self.api.cta_enter_short(id, bytes(stdCode, encoding="utf8"), qty, bytes(usertag, encoding="utf8"), limitprice,
                                 stopprice)

    def cta_exit_short(self, id: int, stdCode: str, qty: float, usertag: str, limitprice: float = 0.0,
                       stopprice: float = 0.0):
        """
        平空
        @id         策略id
        ...
        @qty        手数, 大于等于0
        """
        self.api.cta_exit_short(id, bytes(stdCode, encoding="utf8"), qty, bytes(usertag, encoding="utf8"), limitprice,
                                stopprice)
    ...
    def cta_get_bars(self, id: int, stdCode: str, period: str, count: int, isMain: bool):
        ...
        @isMain     是否主K线
        """
        return self.api.cta_get_bars(id, bytes(stdCode, encoding="utf8"), bytes(period, encoding="utf8"), count, isMain,
    ...
    def cta_get_ticks(self, id: int, stdCode: str, count: int):
        ...
        @count      条数
        """
        return self.api.cta_get_ticks(id, bytes(stdCode, encoding="utf8"), count,
    ...
    def cta_get_position(self, id: int, stdCode: str, bonlyvalid: bool = False, usertag: str = ""):
        ...
        """
        return self.api.cta_get_position(id, bytes(stdCode, encoding="utf8"), bonlyvalid,
    ...
    def cta_set_position(self, id: int, stdCode: str, qty: float, usertag: str = "", limitprice: float = 0.0,
                         stopprice: float = 0.0):
        """
        设置目标仓位
        @id         策略id
        ...
        @qty        目标仓位, 正为多, 负为空
        """
        self.api.cta_set_position(id, bytes(stdCode, encoding="utf8"), qty, bytes(usertag, encoding="utf8"), limitprice,
                                  stopprice)
    ...
    def cta_get_detail_profit(self, id: int, stdCode: str, usertag: str, flag: int):
        ...
        @return     盈亏 
        """
        return self.api.cta_get_detail_profit(id, bytes(stdCode, encoding="utf8"), bytes(usertag, encoding="utf8"),
                                              flag)
    ...
    def cta_register_index_line(self, id: int, idxName: str, lineName: str, lineType: int = 0) -> bool:
        ...
        """
        return self.api.cta_register_index_line(id, bytes(idxName, encoding="utf8"), bytes(lineName, encoding="utf8"),
                                                lineType)
    ...
    def cta_add_index_baseline(self, id: int, idxName: str, lineName: str, value: float) -> bool:
        ...
        @value      数值
        """
        return self.api.cta_add_index_baseline(id, bytes(idxName, encoding="utf8"), bytes(lineName, encoding="utf8"),
                                               value)
    ...
    def sel_get_bars(self, id: int, stdCode: str, period: str, count: int):
        ...
        @count  条数
        """
        return self.api.sel_get_bars(id, bytes(stdCode, encoding="utf8"), bytes(period, encoding="utf8"), count,
                                     CB_STRATEGY_GET_BAR(self.on_stra_get_bar))
    ...
    def sel_get_ticks(self, id: int, stdCode: str, count: int):
        ...
        @count  条数
        """
        return self.api.sel_get_ticks(id, bytes(stdCode, encoding="utf8"), count,
                                      CB_STRATEGY_GET_TICK(self.on_stra_get_tick))
    ...
    def sel_get_position(self, id: int, stdCode: str, bonlyvalid: bool = False, usertag: str = ""):
        ...
        @return 指定合约的持仓手数, 正为多, 负为空
        """
        return self.api.sel_get_position(id, bytes(stdCode, encoding="utf8"), bonlyvalid,
                                         bytes(usertag, encoding="utf8"))
    ...
    def sel_get_detail_profit(self, id: int, stdCode: str, usertag: str, flag: int):
        ...
        @return     盈亏 
        """
        return self.api.sel_get_detail_profit(id, bytes(stdCode, encoding="utf8"), bytes(usertag, encoding="utf8"),
                                              flag)
    ...
    def hft_get_bars(self, id: int, stdCode: str, period: str, count: int):
        ...
        @count  条数
        """
        return self.api.hft_get_bars(id, bytes(stdCode, encoding="utf8"), bytes(period, encoding="utf8"), count,
                                     CB_STRATEGY_GET_BAR(self.on_stra_get_bar))
    ...
    def hft_get_ticks(self, id: int, stdCode: str, count: int):
        ...
        @count  条数
        """
        return self.api.hft_get_ticks(id, bytes(stdCode, encoding="utf8"), count,
                                      CB_STRATEGY_GET_TICK(self.on_stra_get_tick))
    ...
    def hft_get_ordque(self, id: int, stdCode: str, count: int):
        ...
        @count     条数
        """
        return self.api.hft_get_ordque(id, bytes(stdCode, encoding="utf8"), count,
    ...
    def hft_get_orddtl(self, id: int, stdCode: str, count: int):
        ...
        @count     条数
        """
        return self.api.hft_get_orddtl(id, bytes(stdCode, encoding="utf8"), count,
    ...
    def hft_get_trans(self, id: int, stdCode: str, count: int):
        ...
        @count     条数
        """
        return self.api.hft_get_trans(id, bytes(stdCode, encoding="utf8"), count,
    ...
    def init_cta_mocker(self, name: str, slippage: int = 0, hook: bool = False, persistData: bool = True,
                        incremental: bool = False, isRatioSlp: bool = False) -> int:
        """
        创建策略环境
        @name       策略名称 
        @slippage   滑点大小
    ...
    def init_sel_mocker(self, name: str, date: int, time: int, period: str, trdtpl: str = "CHINA",
                        session: str = "TRADING", slippage: int = 0, isRatioSlp: bool = False) -> int:
        """
        创建策略环境
        @name      策略名称
        @return    系统内策略ID 
        ...
        return self.api.init_sel_mocker(bytes(name, encoding="utf8"), date, time,
                                        ...
                                        bytes(session, encoding="utf8"), slippage, isRatioSlp)
