...
NpTypeTick = np.dtype([('exchg', 'S16'), ('code', 'S32'), ('price', 'd'), ('open', 'd'), ('high', 'd'), ('low', 'd'),
                       ('settle_price', 'd'),
                       ('upper_limit', 'd'), ('lower_limit', 'd'), ('total_volume', 'd'), ('volume', 'd'),
                       ('total_turnover', 'd'), ('turn_over', 'd'),
                       ('open_interest', 'd'), ('diff_interest', 'd'), ('trading_date', 'u4'), ('action_date', 'u4'),
                       ('action_time', 'u4'),
                       ('reserve', 'u4'), ('pre_close', 'd'), ('pre_settle', 'd'), ('pre_interest', 'd'),
                       ('bid_price_0', 'd'), ('bid_price_1', 'd'), ('bid_price_2', 'd'), ('bid_price_3', 'd'),
                       ('bid_price_4', 'd'),
                       ('bid_price_5', 'd'), ('bid_price_6', 'd'), ('bid_price_7', 'd'), ('bid_price_8', 'd'),
                       ('bid_price_9', 'd'),
                       ('ask_price_0', 'd'), ('ask_price_1', 'd'), ('ask_price_2', 'd'), ('ask_price_3', 'd'),
                       ('ask_price_4', 'd'),
                       ('ask_price_5', 'd'), ('ask_price_6', 'd'), ('ask_price_7', 'd'), ('ask_price_8', 'd'),
                       ('ask_price_9', 'd'),
                       ('bid_qty_0', 'd'), ('bid_qty_1', 'd'), ('bid_qty_2', 'd'), ('bid_qty_3', 'd'),
                       ('bid_qty_4', 'd'),
                       ('bid_qty_5', 'd'), ('bid_qty_6', 'd'), ('bid_qty_7', 'd'), ('bid_qty_8', 'd'),
                       ('bid_qty_9', 'd'),
                       ('ask_qty_0', 'd'), ('ask_qty_1', 'd'), ('ask_qty_2', 'd'), ('ask_qty_3', 'd'),
                       ('ask_qty_4', 'd'),
                       ('ask_qty_5', 'd'), ('ask_qty_6', 'd'), ('ask_qty_7', 'd'), ('ask_qty_8', 'd'),
                       ('ask_qty_9', 'd')])

NpTypeTrans = np.dtype(
    [('exchg', 'S16'), ('code', 'S32'), ('trading_date', 'u4'), ('action_date', 'u4'), ('action_time', 'u4'),
     ('reserve1', 'u4'), ('index', 'u8'), ('ttype', 'i4'), ('side', 'i4'), ('price', 'd'), ('volume', 'u4'),
     ('reserve2', 'u4'),
     ('askorder', 'i8'), ('bidorder', 'i8')])

NpTypeOrdQue = np.dtype(
    [('exchg', 'S16'), ('code', 'S32'), ('trading_date', 'u4'), ('action_date', 'u4'), ('action_time', 'u4'),
     ('side', 'u4'), ('price', 'd'), ('order_items', 'u4'), ('qsize', 'i8'), ('volumes', 'u4', 50)])

NpTypeOrdDtl = np.dtype(
    [('exchg', 'S16'), ('code', 'S32'), ('trading_date', 'u4'), ('action_date', 'u4'), ('action_time', 'u4'),
     ('reserve1', 'u4'), ('index', 'u8'), ('price', 'd'), ('volume', 'u4'), ('side', 'u4'), ('otype', 'u4'),
     ('reserve2', 'u4')])
