...
def strategy_analyze(workbook: Workbook, df_closes, df_trades, df_funds, capital, rf=0.0, period=240):
    ...
    df_temp2['profit'] = df_closes[df_closes['direct'] == 'SHORT']['profit'] - \
                         df_closes[df_closes['direct'] == 'SHORT']['fee']
...
class WtBtAnalyst:
    ...
    def run_flat(self):
        for sname in self.__strategies__:
            ...
            df_closes['fee'] = df_closes['profit'] - df_closes['totalprofit'] + df_closes['totalprofit'].shift(
                1).fillna(value=0)
